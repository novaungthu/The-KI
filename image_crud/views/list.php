<?php
$this->set_css('image_crud/css/fineuploader.css');
$this->set_css('image_crud/css/photogallery.css');
$this->set_css('image_crud/css/colorbox.css');

$this->set_js('image_crud/js/jquery-1.8.2.min.js');
$this->set_js('image_crud/js/jquery-ui-1.9.0.custom.min.js');

$this->set_js('image_crud/js/jquery.fineuploader-3.5.0.min.js');
$this->set_js('image_crud/js/jquery.colorbox-min.js');
?>
...
<?php } ?>
    ...
    function createUploader() {
        var uploader = new qq.FineUploader({
            ...
            callbacks: {
                onComplete: function() {
                    if ($('.qq-upload-list > li').length == $('.qq-upload-list > .qq-upload-success').length) {
                        loadPhotoGallery();
                    }
                }
            },
