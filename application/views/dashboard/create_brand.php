        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name" name="name" placeholder="ABNEGATION" value="<?php echo set_value("name", ""); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="brand_type" class="col-sm-4 control-label">Brand Type <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="brand_type" name="brand_type" placeholder="T-shirt Plus Size" value="<?php echo set_value("brand_type", ""); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="country" class="col-sm-4 control-label">Country </label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="country" name="country" placeholder="UK" value="<?php echo set_value("country", ""); ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <label class="radio-inline">
                            <input type="radio" name="is_designer" id="is_designer" value="<?php echo YES;?>" <?php echo set_radio("is_designer", YES);?>>Yes
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="is_designer" id="is_designer" value="<?php echo NO;?>" <?php echo set_radio("is_designer", NO, TRUE);?>>No
                        </label>
                    </div>
                </div>
                <div class="form-group">
